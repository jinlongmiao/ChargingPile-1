<template>
  <div class="app-container">
    <div class="filter-container">
      <el-form>
        <el-form-item>
          <el-button type="success" icon="plus" v-if="hasPerm('Role:addRoleUser')"  @click="showCreate">添加用户
          </el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    methods: {
      getAllRoles() {
        this.api({
          ...
          console.log("User.vue/User/getAllRoles");
      ...
      updateUser() {
        //修改用户信息
        let _vue = this;
        console.log('user.vue/User/updateUser');

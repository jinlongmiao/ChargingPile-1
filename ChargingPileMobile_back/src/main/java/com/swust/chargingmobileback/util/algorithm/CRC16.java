...
public class CRC16 {
    ...
    public static void main(String[] args) {
        // 测试数据：0A0000000123455678890000000000070000000000000000
        // String hexString =
        // "0A0000000123455678890000000000070000000000000000";//41f8
        String hexString = "018081258303A1223344050C00";// 39ce
        byte[] test = HexStringToBinary(hexString);
        int crcInt = calcCrc16(test);
        String crcString = (Integer.toHexString(crcInt)).toUpperCase();
        // 获取16进制校验码
        System.out.println(crcString);// 41f8
    }
